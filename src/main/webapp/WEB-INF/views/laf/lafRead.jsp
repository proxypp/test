  ...
  <div id="main">
    ...
    <div class="card" style="height: 700px;">
      ...
      <form name="form1" method="post">
        <label for="number"><h1 style="color: blue">번호&nbsp;&nbsp;</h1>
         	<div><h3>${laf.lnum}</h3> </div>
        </label><br>
        <label for="model"><h1 style="color: blue">모델</h1>
         	<div><h3>${laf.lmodel}</h3> </div>
        </label><br>
        <label for="name"><h1 style="color: blue">이름</h1>
         	<div><h3>${laf.lname}</h3> </div>
        </label><br>
        <label for="location"><h1 style="color: blue">현재 있는 위치</h1>
         	<div><h3>${laf.location}</h3> </div>
        </label>
        <label for="tel"><h1 style="color: blue">전화번호</h1>
         	<div><h3>${laf.ltel}</h3> </div>
        </label>
        <label for="date"><h1 style="color: blue">물건 습득 날짜</h1>
         	<div><h3>${laf.ldate}</h3> </div>
        </label>
        <label>
			<input type="button" value="목록삭제" id="btn2" name="btn2">
		</label>
    </form>
    </div>
  </div>
